      ...
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Data Karyawan Maintenance</h3>
          ...
          <form id="form-tambah-mesin" class="form-horizontal" action="" method="post" enctype="multipart/form-data"> 
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="nrp_mtn" id="nrp_mtn" placeholder="Masukkan NRP Karyawan">
                  <small class="form-text text-danger"><?php echo form_error('nrp_mtn'); ?></small>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="nama_karyawan_mtn" id="nama_karyawan" placeholder="Masukkan Nama Karyawan">
