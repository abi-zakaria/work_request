      ...
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Form Work Request Dikerjakan</h3>
          ...
          <form id="" class="form-horizontal" action="" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="no_mesin" id="no_mesin" value="<?php echo $no_wr['no_mesin']; ?>" disabled>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="work_center" class="col-sm-2 control-label">Tanggal dan Jam Dikerjakan</label>
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" name="tgl_wr" value="<?php echo $tanggal_dikerjakan ?>">
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $jam_dikerjakan ?>">
                  </div>
                </div>
              </div>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-info pull-right">Kerjakan Work Request</button>
            </div>
            <!-- /.box-footer -->
          </form>
        </div>
