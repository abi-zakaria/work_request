...
<body class="hold-transition login-page" style="font-family: Cursive;">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg"><b>Silahkan Login Disini</b></p>
      <?php
      if(isset($_GET['pesan'])){
        if($_GET['pesan']=="gagal"){
          ...
          if($this->session->flashdata())
          {
            ...
            echo $this->session->flashdata('Anda Belum Login');
            echo "</div>";
          }
        }
      }else{
      ...
      <form action="<?php echo base_url().'home/auth' ?>" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-md-12">
            <button type="submit" class="btn btn-primary btn-flat pull pull-right">Login</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
